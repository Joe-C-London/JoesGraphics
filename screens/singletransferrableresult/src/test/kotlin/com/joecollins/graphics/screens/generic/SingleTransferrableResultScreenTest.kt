...
class SingleTransferrableResultScreenTest {
    ...
    fun displayCandidates() {
        ...
        val excluded = Publisher<List<Pair<Candidate, String>>>(emptyList())
        ...
        excluded.submit(listOf(mckeag to "EXCLUDED IN 2"))
        ...
        excluded.submit(listOf(mckeag to "EXCLUDED IN 2", defaoite to "EXCLUDED IN 3"))
        ...
        excluded.submit(listOf(mckeag to "EXCLUDED IN 2", defaoite to "EXCLUDED IN 3", bodel to "EXCLUDED IN 4", robinson to "EXCLUDED IN 4"))
        ...
        excluded.submit(listOf(mckeag to "EXCLUDED IN 2", defaoite to "EXCLUDED IN 3", bodel to "EXCLUDED IN 4", robinson to "EXCLUDED IN 4", girvin to "EXCLUDED IN 5"))
        ...
        excluded.submit(listOf(mckeag to "EXCLUDED IN 2", defaoite to "EXCLUDED IN 3", bodel to "EXCLUDED IN 4", robinson to "EXCLUDED IN 4", girvin to "EXCLUDED IN 5", odonnell to "EXCLUDED IN 6"))
        ...
        excluded.submit(listOf(mckeag to "EXCLUDED IN 2", defaoite to "EXCLUDED IN 3", bodel to "EXCLUDED IN 4", robinson to "EXCLUDED IN 4", girvin to "EXCLUDED IN 5", odonnell to "EXCLUDED IN 6", milne to "EXCLUDED IN 7"))
        ...
        excluded.submit(listOf(mckeag to "EXCLUDED IN 2", defaoite to "EXCLUDED IN 3", bodel to "EXCLUDED IN 4", robinson to "EXCLUDED IN 4", girvin to "EXCLUDED IN 5", odonnell to "EXCLUDED IN 6", milne to "EXCLUDED IN 7", kyle to "EXCLUDED IN 8"))
        ...
        excluded.submit(listOf(mckeag to "EXCLUDED IN 2", defaoite to "EXCLUDED IN 3", bodel to "EXCLUDED IN 4", robinson to "EXCLUDED IN 4", girvin to "EXCLUDED IN 5", odonnell to "EXCLUDED IN 6", milne to "EXCLUDED IN 7", kyle to "EXCLUDED IN 8", douglas to "EXCLUDED IN 11"))
    ...
    @Test
    fun displayCandidatesWithExcluded() {
        val apni = Party("Alliance", "APNI", Color.ORANGE)
        val uup = Party("Ulster Unionist Party", "UUP", Color.BLUE)
        val dup = Party("Democratic Unionist Party", "DUP", Color.ORANGE.darker())
        val pup = Party("Progressive Unionist Party", "PUP", Color.BLUE.darker())
        ...
        val panel = SingleTransferrableResultScreen.of(
            candidateResults = {
                ...
                this.progress = candidateProgress
                this.incumbentMarker = "MLA"
                this.showExcludedCandidates = { true }
            },
            partyTotals = {
                totalSeats = 5.asOneTimePublisher()
                header = "TOTAL QUOTAS BY PARTY".asOneTimePublisher()
        ...
        assertPublishes(
            ...
            """
                ...
                SHEILA BODEL (CON): 278.43 (0.04)
                SÉAMUS DE FAOITE (SDLP): 260.56 (0.04) EXCLUDED
                JORDY MCKEAG (IND): EXCLUDED IN 2
                QUOTA: 6,727
        ...
        assertPublishes(
            ...
            """
                ...
                COURTNEY ROBINSON (LAB-ALT): 467.81 (0.07) EXCLUDED
                SHEILA BODEL (CON): 280.43 (0.04) EXCLUDED
                SÉAMUS DE FAOITE (SDLP): EXCLUDED IN 3
                JORDY MCKEAG (IND): EXCLUDED IN 2
                QUOTA: 6,727
        ...
        assertPublishes(
            ...
            """
                ...
                MAIRÉAD O'DONNELL (SF): 1,232.88 (0.18)
                ANDREW GIRVIN (TUV): 958.87 (0.14) EXCLUDED
                COURTNEY ROBINSON (LAB-ALT): EXCLUDED IN 4
                SHEILA BODEL (CON): EXCLUDED IN 4
                SÉAMUS DE FAOITE (SDLP): EXCLUDED IN 3
                JORDY MCKEAG (IND): EXCLUDED IN 2
                QUOTA: 6,727
        ...
        assertPublishes(
            ...
            """
                ...
                GEORGINA MILNE (GRN): 1,801.58 (0.27)
                MAIRÉAD O'DONNELL (SF): 1,235.10 (0.18) EXCLUDED
                ANDREW GIRVIN (TUV): EXCLUDED IN 5
                COURTNEY ROBINSON (LAB-ALT): EXCLUDED IN 4
                SHEILA BODEL (CON): EXCLUDED IN 4
                SÉAMUS DE FAOITE (SDLP): EXCLUDED IN 3
                JORDY MCKEAG (IND): EXCLUDED IN 2
        ...
        assertPublishes(
            ...
            """
                ...
                JOHN KYLE (PUP): 2,950.28 (0.44)
                GEORGINA MILNE (GRN): 2,080.65 (0.31) EXCLUDED
                MAIRÉAD O'DONNELL (SF): EXCLUDED IN 6
                ANDREW GIRVIN (TUV): EXCLUDED IN 5
                COURTNEY ROBINSON (LAB-ALT): EXCLUDED IN 4
                SHEILA BODEL (CON): EXCLUDED IN 4
                SÉAMUS DE FAOITE (SDLP): EXCLUDED IN 3
        ...
        assertPublishes(
            ...
            """
                ...
                DAVID DOUGLAS (DUP): 4,599.73 (0.68)
                JOHN KYLE (PUP): 3,148.79 (0.47) EXCLUDED
                GEORGINA MILNE (GRN): EXCLUDED IN 7
                MAIRÉAD O'DONNELL (SF): EXCLUDED IN 6
                ANDREW GIRVIN (TUV): EXCLUDED IN 5
                COURTNEY ROBINSON (LAB-ALT): EXCLUDED IN 4
                SHEILA BODEL (CON): EXCLUDED IN 4
