...
class SwingometerFrameBuilderTest {
    ...
    fun testOuterLabels() {
        ...
        val labels = BindableList<OuterLabel>()
        labels.add(OuterLabel(Color.RED, "306", 0.0))
        labels.add(OuterLabel(Color.RED, "350", 2.66))
        labels.add(OuterLabel(Color.RED, "400", 7.855))
        labels.add(OuterLabel(Color.RED, "450", 11.245))
        labels.add(OuterLabel(Color.RED, "500", 15.055))
        labels.add(OuterLabel(Color.BLUE, "270", -0.385))
        labels.add(OuterLabel(Color.BLUE, "350", -2.565))
    ...
    fun testDotsWithLabels() {
        ...
        val dots = BindableList<Dot>()
        dots.add(Dot(0.115, Color.RED, "16"))
        dots.add(Dot(0.36, Color.RED, "20"))
        dots.add(Dot(0.385, Color.RED, "10"))
        dots.add(Dot(0.6, Color.RED, "29"))
    ...
    fun testDotsSolidOrEmpty() {
        ...
        val dots = BindableList<Dot>()
        dots.add(Dot(0.115, Color.RED, true))
        dots.add(Dot(0.36, Color.RED, true))
        dots.add(Dot(0.385, Color.RED, true))
        dots.add(Dot(0.6, Color.RED, true))
