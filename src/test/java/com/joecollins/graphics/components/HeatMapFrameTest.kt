...
class HeatMapFrameTest {
    ...
    private val peiResults: Map<Int, Pair<Color, Color>>
        get() = java.util.Map.ofEntries(
                ImmutablePair.of(1, ImmutablePair.of(Color.BLUE, Color.BLUE)),
                ImmutablePair.of(2, ImmutablePair.of(Color.BLUE, Color.BLUE)),
                ImmutablePair.of(3, ImmutablePair.of(Color.RED, Color.BLUE)),
                ImmutablePair.of(4, ImmutablePair.of(Color.BLUE, Color.BLUE)),
                ImmutablePair.of(5, ImmutablePair.of(Color.RED, DARK_GREEN)),
                ImmutablePair.of(6, ImmutablePair.of(Color.BLUE, Color.BLUE)),
                ImmutablePair.of(7, ImmutablePair.of(Color.BLUE, Color.BLUE)),
                ImmutablePair.of(8, ImmutablePair.of(Color.RED, Color.BLUE)),
                ImmutablePair.of(9, ImmutablePair.of(Color.RED, Color.BLUE)),
                ImmutablePair.of(10, ImmutablePair.of(Color.RED, Color.RED)),
                ImmutablePair.of(11, ImmutablePair.of(Color.RED, DARK_GREEN)),
                ImmutablePair.of(12, ImmutablePair.of(Color.RED, DARK_GREEN)),
                ImmutablePair.of(13, ImmutablePair.of(Color.RED, DARK_GREEN)),
                ImmutablePair.of(14, ImmutablePair.of(Color.RED, Color.RED)),
                ImmutablePair.of(15, ImmutablePair.of(Color.RED, Color.BLUE)),
                ImmutablePair.of(16, ImmutablePair.of(Color.RED, Color.RED)),
                ImmutablePair.of(17, ImmutablePair.of(DARK_GREEN, DARK_GREEN)),
                ImmutablePair.of(18, ImmutablePair.of(Color.BLUE, Color.BLUE)),
                ImmutablePair.of(19, ImmutablePair.of(Color.BLUE, Color.BLUE)),
                ImmutablePair.of(20, ImmutablePair.of(Color.BLUE, Color.BLUE)),
                ImmutablePair.of(21, ImmutablePair.of(Color.RED, DARK_GREEN)),
                ImmutablePair.of(22, ImmutablePair.of(Color.RED, DARK_GREEN)),
                ImmutablePair.of(23, ImmutablePair.of(Color.RED, DARK_GREEN)),
                ImmutablePair.of(24, ImmutablePair.of(Color.RED, Color.RED)),
                ImmutablePair.of(25, ImmutablePair.of(Color.RED, Color.RED)),
                ImmutablePair.of(26, ImmutablePair.of(Color.RED, Color.BLUE)),
                ImmutablePair.of(27, ImmutablePair.of(Color.RED, Color.RED)))
