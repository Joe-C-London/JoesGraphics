...
class HemicycleFrameBuilderTest {
    ...
    fun testHemicycleBasic() {
        ...
        val leftSeatBars = BindableList<Pair<Color, Int>>(listOf(ImmutablePair.of(Color.GREEN, 8)))
        val rightSeatBars = BindableList<Pair<Color, Int>>(listOf(ImmutablePair.of(Color.BLUE, 13)))
        val middleSeatBars = BindableList<Pair<Color, Int>>(listOf(ImmutablePair.of(Color.RED, 6)))
        val leftChangeBars = BindableList<Pair<Color, Int>>(listOf(ImmutablePair.of(Color.GREEN, +7)))
        val rightChangeBars = BindableList<Pair<Color, Int>>(listOf(ImmutablePair.of(Color.BLUE, +5)))
        val frame = of(
                rows,
                dots,
                ...
                .withLeftSeatBars(leftSeatBars, { it.left }, { it.right }, fixedBinding("GREEN: 8"))
                .withRightSeatBars(rightSeatBars, { it.left }, { it.right }, fixedBinding("PROGRESSIVE CONSERVATIVE: 13"))
                .withMiddleSeatBars(middleSeatBars, { it.left }, { it.right }, fixedBinding("LIBERAL: 6"))
                .withLeftChangeBars(leftChangeBars, { it.left }, { it.right }, fixedBinding(1), fixedBinding("GRN: +7"))
                .withRightChangeBars(rightChangeBars, { it.left }, { it.right }, fixedBinding(8), fixedBinding("PC: +5"))
