...
public class SeatsChangingScreenTest {
  ...
  @Test
  public void testSeatsChanging() throws IOException {
    ...
    currResult.setValue(
        Map.of(
            "Coquitlam-Burke Mountain", PartyResult.leading(ndp),
            "Fraser-Nicola", PartyResult.leading(ndp),
            "Vancouver-False Creek", PartyResult.leading(ndp)));
    compareRendering("SeatsChangingScreen", "Basic-2", panel);

    currResult.setValue(
        Map.of(
            "Coquitlam-Burke Mountain", PartyResult.elected(ndp),
            "Fraser-Nicola", PartyResult.leading(lib),
            "Richmond-Queensborough", PartyResult.leading(ndp),
            "Vancouver-False Creek", PartyResult.leading(ndp)));
  ...
  @Test
  public void testFilteredSeatsChanging() throws IOException {
    BindableWrapper<Map<String, Map<Party, Integer>>> prevResult =
        new BindableWrapper<>(bcPrevResult());
    BindableWrapper<Map<String, PartyResult>> currResult = new BindableWrapper<>(Map.of());
    BindableWrapper<Integer> numRows = new BindableWrapper<>(15);
    BindableWrapper<String> title = new BindableWrapper<>("VANCOUVER");
  ...
  @Test
  public void testSeatsChangingNullResults() throws IOException {
    BindableWrapper<Map<String, Map<Party, Integer>>> prevResult =
        new BindableWrapper<>(bcPrevResult());
