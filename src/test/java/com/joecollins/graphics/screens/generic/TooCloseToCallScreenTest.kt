...
class TooCloseToCallScreenTest {
    ...
    private fun setupFirstAdvancePoll(
        candidateVotes: MutableMap<Int, Map<Candidate, Int>>,
        partyResults: MutableMap<Int, PartyResult>,
        ...
        partyResults[1] = leading(pc)
        pctReporting[1] = 1.0 / 10
    }

    private fun setupAllAdvancePolls(
        candidateVotes: MutableMap<Int, Map<Candidate, Int>>,
        partyResults: MutableMap<Int, PartyResult>,
        pctReporting: MutableMap<Int, Double>
    ) {
        ...
        partyResults[27] = leading(lib)
        pctReporting[27] = 1.0 / 10
    }

    private fun setupHalfOfPolls(
        candidateVotes: MutableMap<Int, Map<Candidate, Int>>,
        partyResults: MutableMap<Int, PartyResult>,
        pctReporting: MutableMap<Int, Double>
    ) {
        ...
        partyResults[27] = elected(lib)
        pctReporting[27] = 5.0 / 10
    }

    private fun setupFullResults(
        candidateVotes: MutableMap<Int, Map<Candidate, Int>>,
        partyResults: MutableMap<Int, PartyResult>,
        pctReporting: MutableMap<Int, Double>
    ) {
