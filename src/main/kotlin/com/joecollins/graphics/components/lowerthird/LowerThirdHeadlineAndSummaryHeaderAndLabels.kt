...
class LowerThirdHeadlineAndSummaryHeaderAndLabels internal constructor(
    ...
    companion object {
        fun createSeatEntries(seats: Map<Party, Int>, totalSeats: Int = 0): List<SummaryWithHeaderAndLabels.Entry> {
            ...
            if (inDoubt > 0) {
                ret.add(SummaryWithHeaderAndLabels.Entry(Color.WHITE, "?", inDoubt.toString()))
            }
            if (ret.isEmpty()) {
