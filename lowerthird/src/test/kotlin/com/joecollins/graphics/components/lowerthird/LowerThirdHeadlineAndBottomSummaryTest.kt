...
class LowerThirdHeadlineAndBottomSummaryTest {
    ...
    fun testSummaryPanel() {
        ...
        Assertions.assertEquals(Color.WHITE, lowerThird.getEntryColor(5))
        Assertions.assertEquals("LIB", lowerThird.getEntryLabel(0))
        Assertions.assertEquals("CON", lowerThird.getEntryLabel(1))
        Assertions.assertEquals("?", lowerThird.getEntryLabel(5))
        Assertions.assertEquals("2", lowerThird.getEntryValue(0))
        Assertions.assertEquals("1", lowerThird.getEntryValue(1))
        Assertions.assertEquals("335", lowerThird.getEntryValue(5))
        Assertions.assertEquals("SEATS WON", lowerThird.summaryHeader)
        Assertions.assertEquals("170 FOR MAJORITY", lowerThird.summaryFooter)
    }
