...
class BattlefieldFrameTest {
    ...
    @Test
    fun testRenderBattlefieldWithTerritories() {
        val frame = BattlefieldFrame(
            headerPublisher = "PEI 2019 BATTLEFIELD".asOneTimePublisher(),
            limitPublisher = 80.asOneTimePublisher(),
            incrementPublisher = 10.asOneTimePublisher(),
            ...
            territoriesPublisher = BattlefieldFrame.Territories(
                ColorUtils.lighten(ColorUtils.lighten(Color.BLUE)),
                ColorUtils.lighten(ColorUtils.lighten(Color.RED)),
                ColorUtils.lighten(ColorUtils.lighten(Color.GREEN.darker())),
            ).asOneTimePublisher(),
        )
        frame.setSize(1024, 512)
        RenderTestUtils.compareRendering("BattlefieldFrame", "WithTerritories", frame)
    }

    @Test
    fun testRenderBattlefieldWithShiftedTerritories() {
        val frame = BattlefieldFrame(
            headerPublisher = "PEI 2019 BATTLEFIELD".asOneTimePublisher(),
            limitPublisher = 80.asOneTimePublisher(),
            incrementPublisher = 10.asOneTimePublisher(),
        ...
        frame.setSize(1024, 512)
        RenderTestUtils.compareRendering("BattlefieldFrame", "WithShiftedTerritories", frame)
    }
}
