...
class SwingometerFrameTest {
    ...
    private fun createSwingometerDotsWithoutLabels(): Publisher<List<Triple<String, Double, Color>>> = Publisher(
        listOf(
    ...
    private fun createSwingometerDotsWithLabels(): Publisher<List<Triple<Pair<String, Int>, Double, Color>>> = Publisher(
        listOf(
